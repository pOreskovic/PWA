...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-3 col-md-12 col-sm-12">
                    <nav>
                        <ul>
                            <li><a href="index.php" style="border: 3px solid #f44336;">Home</a></li>
    ...
    <main>
        ...
        <section class="world"><br><a name="wnews"></a>
        <h1>orld News</h1><br>
            <?php 
            $q = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='World News' LIMIT 3";
        ...
        <section class="comp"><a name="compet"></a>
            <h1>pcoming Competitions</h1><br>
            <?php 
            $q = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='Upcoming Competitions' LIMIT 3";
            $qres = mysqli_query($dbc, $q);
